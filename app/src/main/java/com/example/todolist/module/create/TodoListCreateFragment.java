...
import com.example.todolist.module.dashboard.MainActivityBase;
...
public class TodoListCreateFragment extends BaseFragment<TodoListCreate, TodoListCreateContract.Presenter> implements TodoListCreateContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragmentView = inflater.inflate(R.layout.Membuat_Todolist, container, false);
    ...
    public void redirectToTaskList() {
        Intent intent = new Intent(activity, MainActivityBase.class);
